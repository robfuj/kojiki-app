...
export const en = {
  ...
  tabs: {
    ...
    overview: {
      ...
      overallProgress: '{percent}% overall progress',
      active: 'Active',
      gates: '{count} decision gates',
    ...
    work: {
      ...
      krEmpty:
        'No measured criteria yet. Key results appear when tasks carry success criteria.',
      metric: 'Metric',
      target: 'Target',
      actual: 'Actual',
      status: 'Status',
    ...
    decisions: {
      subtitle: 'Track and manage decisions across all departments.',
      ...
      stage: 'Stage',
      source: 'Source',
      empty: 'Select a decision to read it.',
      none: 'No decisions recorded yet.',
      statuses: {
        proposed: 'Review',
        accepted: 'Approved',
        rejected: 'Archived',
    ...
    departments: {
      subtitle: 'The department agents staffed on this project.',
      goals: 'Goals',
      decisions: 'Decisions',
      members: 'Members',
      info: 'Info',
      ...
      empty: 'No department agents yet.',
      mandate: 'Mandate',
      functionLine: 'Function',
      rights: 'Decision rights',
      handoffs: 'Hands off to',
      noSubAgents: 'No sub-agents registered under this function.',
    },
    evidence: {
      subtitle: 'Verified information from trusted sources.',
      ...
      close: 'Close',
      empty: 'Select a document to read it.',
      none: 'No documents yet. Upload one to give the agents grounded context.',
      library: 'Library',
    },
    learning: {
      subtitle: 'Insights and improvements from past decisions.',
      insights: 'Insights',
      patterns: 'Patterns',
      retrospectives: 'Retrospectives',
      basedOn: '{agent} · {errorClass}',
      takeaways: 'Key Takeaways',
      empty: 'No reusable learnings yet. Kaizen seals them after validated work.',
    ...
    orchestrator: {
      ...
      reviewEmpty:
        'No review yet. Run one and the orchestrator reads the whole project — objectives, tasks, gates and agent traffic.',
      findings: 'Findings',
      recommended: 'Recommended actions',
      askDept: 'Ask {name}',
      createDecision: 'Record decision',
